...
module.exports = {
    ...
    route_info: [
        ...
        ,{file: './user', path: '/process/logout', method:'logout',type:'put'}
        ,{file: './user', path: '/process/secession', method:'deleteUser',type:'delete'}
        ...
        ,{file: './mypage', path: '/mypage/nickname', method: 'putNickname', type: 'put'}
    ]
}